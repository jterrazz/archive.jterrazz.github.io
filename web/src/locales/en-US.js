const enTranslation = {
  ...
  myIntroductionText: "I love connecting the most innovative companies with their customers through <b>efficient, well designed code and beautiful interfaces</b>. " +
  ...
  myInformationsText: "My <b>passion for technology</b> since my youngest age led me into joining the most innovative programming school: the <b>Paris 42 School</b>. " +
    ...
    "<br/><br/>I'm always curious for new adventures, so don't hesitate to contact me with your crazy ideas!",
  ...
  projects: {
    ...
    "myshop-eth": "A decentralized, open and social platform that enable direct peer to peer markets.",
    ...
    "react-native-learning": "A collection of projects to learn about react native.",
    ...
    "42-libft-asm": "Basic library implemented in Assembly using the x86 Intel syntax.",
    ...
    "42-corewar": "Virtual machine simulating basic processors operations, with simple notions of Assembly.",
    ...
    "dalia-b2b": "At Dalia, we had the idea to create a new B2B product for the company. The goal was to provide merchant websites an API that would allow their clients to gift products, only by knowing the receiver phone number / email. Find more about this project on LinkedIn.",
